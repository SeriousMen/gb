...
<html>
	...
	<body>
		<c:set var="b_vo" value="${b_vo}"/> <%--작성됬을 때의 정보를 보여주고 담아줘서 넘겨줘야지 --%>
		<center>
			...
			<form action="${pageContext.request.contextPath}/board/BoardModifyOk.bo" method="post" name="modifyForm" enctype = "multipart/form-data">
				<input type="hidden" name="boardNum" value="${b_vo.getBoardNum()}"> <%-- 이렇게 히든타입을 설정해서 따로 입력 없이 데이터를 넘겨준다. --%>
				...
				<table width="900px" border="1" cellpadding="0" cellspacing="0">
					...
					<tr height ="30px">
						...
						<td style="padding-left:10px;">
							...
							<input type ="button" onclick="cancleFile('boardFile1')" value="첨부삭제">
						</td>
					</tr>
					<tr height ="30px">
						<td align="center" width="150px">
