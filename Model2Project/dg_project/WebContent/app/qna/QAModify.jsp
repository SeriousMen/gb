...
<body class="is-preload" style="font-family: 'paybooc-Bold';">
	...
	<div id="main">
		...
		<div class="wrapper">
			<div class="inner">
				<form name="modifyForm" method="post" id="modifyForm"
					action="${pageContext.request.contextPath}/qnaboard/BoardModifyOk.qn"
					enctype="multipart/form-data">
					<div class="row gtr-uniform">
						<div class="col-6 col-12-xsmall" style="margin: 0 auto;">
							<input type="hidden" name="boardNum" value="${q_vo.getQnaNum()}">
							...
							<c:choose>
								<c:when test="${session_a_id != null}">
									...
									<input type="text" name="demo-name" id="demo-name"
										value="[답변 완료]${q_vo.getQnaTitle()}" />
									<textarea name="demo-textarea" id="demo-textarea" rows="6"
										style="margin-top: 30px; resize: none;">${q_vo.getQnaContent()}
-------------------------------------------------------------------------------------------</textarea>
									<ul class="actions fit" style="margin-top: 5%;">
										<li><a href="javascript:modifyBoard()"
											class="button primary small">답변</a></li>
										<li><a class="button primary small"
											href="${pageContext.request.contextPath}/admin/AdminList.ad?q_page=${page}">목록</a></li>
									</ul>
								</c:when>
								<c:otherwise>
								<input type="hidden" name ="memberId" value="${q_vo.getMemberId()}">
									<input type="text" name="demo-name" id="demo-name"
										value="${q_vo.getQnaTitle()}" />
									<textarea name="demo-textarea" id="demo-textarea" rows="6"
										style="margin-top: 30px; resize: none;">${q_vo.getQnaContent()}</textarea>
									<div style="margin-top: 5%;">
										<input type="file" id="file-Button" name="file-Button"
