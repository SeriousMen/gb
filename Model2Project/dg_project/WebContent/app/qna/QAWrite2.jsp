			...
			<div class="inner">
				<c:choose>
					<c:when test="${session_m_id != null}">
						<form name="qnaBoardForm" method="post" id="qnaBoardForm"
							action="${pageContext.request.contextPath}/qnaboard/QnaWriteOk.qn"
							enctype="multipart/form-data">
							<div class="row gtr-uniform">
								<div class="col-6 col-12-xsmall" style="margin: 0 auto;">
									<input type="text" name="demo-title" id="demo-title"
					...
					<c:when test="${session_t_id !=null}">
						<form name="qnaBoardForm" method="post" id="qnaBoardForm"
							...
							<div class="row gtr-uniform">
								<div class="col-6 col-12-xsmall" style="margin: 0 auto;">
									<input type="text" name="demo-title" id="demo-title"
										placeholder="제목을 입력해주세요" /> <input type="text" name="trainerId"
										id="trainerId" value="${session_t_id}" readonly="readonly" />
									<textarea name="demo-textarea" id="demo-textarea" rows="6"
										style="margin-top: 30px; resize: none;"></textarea>
										<div style="margin-top: 5%;">
										<ul class="actions" id="ulTag">
