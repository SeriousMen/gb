		...
		<div class="wrapper" style="padding: 2rem 0 5rem 0;"
			...
			<div class="inner">
				...
				<div class="col-6 col-12-xsmall">
					<h4 style="text-align: center; font-size: 35px;">회원탈퇴</h4>
					<form style="margin: 37px 0 2rem 0;" name="withdrawal"
						id="withdrawal"
						action="${pageContext.request.contextPath}/member/MemberWithdrawalOk.me">
						<div style="display: flex;">
							<input type="text" id="memberId" name="memberId"
								value="${session_m_id}"
								style="width: 50%; margin: 0 auto; text-align: center; " readonly>
						</div>
						...
						<ul class="actions fit" style="display: inherit; padding-top: 5%;">
							<li style="padding-bottom: 3px;"><a
								href="javascript:withdrawal()" class="button primary fit">탈퇴신청</a></li>

							<li><a href="memberPage.jsp" class="button fit">탈퇴취소</a></li>
						</ul>
					</form>
...
<script>
	var withdrawalForm = document.withdrawal;
	function withdrawal() {
		var memberId = withdrawalForm.memberId.value;
		var m_session = '${session_m_id}';
		if (memberId == m_session) {
			withdrawalForm.submit();
		} else {
			alert("본인 아이디를 입력해주세요.");
			return false;
		}
	}
</script>
