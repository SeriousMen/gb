						...
						<form method="post" action="${pageContext.request.contextPath}/review/ReviewWriteOkAction.rv" id="reviewForm" name="reviewForm" enctype="multipart/form-data">
							...
							<div class="row gtr-uniform">
								<div class="col-6 col-12-xsmall" style="margin: 0 auto;">
									<input type="text" name="memberId" id="memberId" value="${session_m_id}" readonly/>
									<textarea name="reviewContent" id="reviewContent" rows="6" style="margin-top: 30px; resize: none;" required="required"></textarea>
									...
									<ul class="actions fit">
										<li><a href="javascript:formSubmit()" class="button primary fit">리뷰 등록</a></li>
									</ul>
								</div>
							</div>
						</form>
