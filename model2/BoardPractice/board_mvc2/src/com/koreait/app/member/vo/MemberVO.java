...
public class MemberVO {
	/*
	 * CREATE TABLE TABLE_MEMBER( memberId VARCHAR2(300), memberPw VARCHAR2(300),
	 * memberName VARCHAR2(300), memberAge NUMBER(3), memberGender VARCHAR2(20),
	 * memberEmail VARCHAR2(200), memberZipcode VARCHAR2(20), memberAddress
	 * VARCHAR2(300), memberAddressDetail VARCHAR2(300), memberAddressEtc
	 * VARCHAR2(100), CONSTRAINT MEMBER_PK PRIMARY KEY(memberId) );
	 */
